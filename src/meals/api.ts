...
export const mealsApi = {
  ...
  createMeal(input: MealInput) { return invoke<Meal>("create_meal", { input }); },
  ...
  createPlannedInstance(input: { weekStart: string; weekday: number; slot: MealSlot; mealId: string }) { return invoke<PlannedInstance>("create_planned_instance", { input }); },
