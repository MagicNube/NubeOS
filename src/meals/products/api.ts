...
export const supermarketLabels: Record<Supermarket, string> = {
  mercadona: "Mercadona", lidl: "Lidl", consum: "Consum", familyCash: "FamilyCash", other: "Otro",
};

export type PurchasePresentation =
  | { kind: "package"; totalGrams: number; priceEur?: string; unitsPerPackage?: number }
...
export const productApi = {
  list(status: ProductStatus) { return invoke<Product[]>("list_products", { status }); },
  create(input: ProductInput) { return invoke<Product>("create_product", { input }); },
